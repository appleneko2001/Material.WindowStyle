...
namespace Material.WindowStyle.Assists
{
    ...
    {
        public static readonly AvaloniaProperty<IBrush> OnHoverProperty = 
            AvaloniaProperty.RegisterAttached<Button, IBrush>("OnHover", typeof(MaterialTitleBarButtonAssist));

        public static IBrush GetOnHover(AvaloniaObject element) => 
            element.GetValue<IBrush>(OnHoverProperty);
